...
from aiogram.utils.exceptions import RetryAfter, Unauthorized, BadRequest, BotBlocked
...
async def send_message(to: Union[str, int], title: Optional[str] = None, text: Optional[str] = None,
                       ...
                       document: InputFile = None, parse_mode: Optional[str] = 'markdown',
                       reply_markup: Optional[InlineKeyboardMarkup] = None, disable_notification: Optional[bool] = True,
    ...
    try:
        ...
        if image_id:
            ...
            await bot.send_document(to, document, reply_markup=reply_markup, disable_notification=disable_notification)
        else:
            logger.info(await bot.send_message(to, message, parse_mode=parse_mode, reply_markup=reply_markup,
                                               disable_notification=disable_notification))
        return True
        ...
        return await send_message(to, title, text, message, image_id, video_id, document, parse_mode, reply_markup,
