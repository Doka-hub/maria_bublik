...
from keyboards.inline.user.mail import get_mail_create_inline_keyboard, get_mail_create_message
...
async def mail_create_send_message_detail(*, callback: Optional[types.CallbackQuery] = None,
    ...
    if callback:
        ...
        mail_data = await dp.storage.get_data(user=user_id)
        ...
        if image_id:
            ...
            await callback.message.answer(text_answer, reply_markup=mail_create_inline_keyboard, parse_mode='markdown')
    elif message:
